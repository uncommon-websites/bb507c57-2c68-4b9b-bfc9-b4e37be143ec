		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-20">
			...
			<div class="lg:col-span-2">
				<a href="/" class="flex items-center gap-2 mb-8">
					...
					<span class="text-xl font-medium tracking-tight">Intentional Development</span>
				</a>
                ...
                <div class="mt-20">
                    ...
                    <div class="text-[10px] text-gray-500 mt-4">© Intentional Development 2025</div>
                </div>
			</div>

			<!-- Column 1 -->
			<div>
				<h4 class="text-xs font-bold text-gray-500 uppercase tracking-wider mb-6">Product</h4>
				<ul class="space-y-3 text-sm text-gray-300">
					<li><a href="#" class="hover:text-white transition-colors">Overview</a></li>
					<li><a href="#" class="hover:text-white transition-colors">Frameworks</a></li>
					<li><a href="#" class="hover:text-white transition-colors">One-on-one guides</a></li>
					<li><a href="#" class="hover:text-white transition-colors">Team rituals</a></li>
			...
			<!-- Column 2 -->
			<div>
				<h4 class="text-xs font-bold text-gray-500 uppercase tracking-wider mb-6">Resources</h4>
				<ul class="space-y-3 text-sm text-gray-300">
					...
					<li><a href="#" class="hover:text-white transition-colors">Workshops</a></li>
					<li><a href="#" class="hover:text-white transition-colors">Community</a></li>
					<li><a href="#" class="hover:text-white transition-colors">Slack channel</a></li>
